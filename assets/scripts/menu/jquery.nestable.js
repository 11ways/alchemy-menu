...
;(function($, window, document, undefined)
{
    ...
    function Plugin(element, options)
    {
        ...
        // If this is a clone source, add the nodrop class
        if (this.options.cloneSource) {
            this.el.addClass(this.options.noDropClass);
        }
    ...
    Plugin.prototype = {
        ...
        dragStart: function(e)
        {
            ...
            // If this list is a clone source, don't remove the original element
            if (this.options.cloneSource) {
            ...
            this.placeEl.css('height', height);
            ...
            if (dragItem[0] && dragItem[0].parentNode) {
        ...
        dragMove: function(e)
        {
            ...
            // If the 'dd-nodrop' class is set, don't allow any drop on this list
            if (pointElRoot.hasClass(opt.noDropClass)) {
                return;
            }
